...
ALTER TABLE ETREAMI ADD FOREIGN KEY (idUt2) REFERENCES UTILISATEUR (idUt);
ALTER TABLE MESSAGE ADD FOREIGN KEY (idUt1) REFERENCES UTILISATEUR (idUt);
ALTER TABLE MESSAGE ADD FOREIGN KEY (idUt2) REFERENCES UTILISATEUR (idUt);
...
ALTER TABLE INVITATION ADD FOREIGN KEY (idUt2) REFERENCES UTILISATEUR (idUt);
ALTER TABLE JEU ADD FOREIGN KEY (idTy) REFERENCES TYPEJEU (idTy);

INSERT INTO ROLE VALUES ('USER'),('ADMIN');
INSERT INTO TYPEJEU (nomTy) VALUES ('Score'),('Speed'),('Turn-based');